 ...
 */
	...
	$client->client_id = '162643658826.apps.googleusercontent.com'; $application_line = __LINE__;
	$client->client_secret = 'jXNJ4v2CW-H44n8td12NfRyJ';
	...
	if(($success = $client->Initialize()))
	{
		if(($success = $client->Process()))
		{
			...
			elseif(strlen($client->access_token))
			{
				 ...
				 */
				//if($success)
					//print_r $success; //= $client->SetUser(1);
			}
		}
